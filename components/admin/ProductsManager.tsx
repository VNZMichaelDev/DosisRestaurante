...
export default function ProductsManager() {
  ...
  const save = async () => {
    ...
    const payload = {
      ...
      stock: editing.stock.trim() === "" ? null : parseInt(editing.stock, 10),
    };
      ...
      {editing ? (
        <div className="am-form card-form">
          ...
          <div className="am-grid">
            ...
            <label className="am-field">
              <span>Stock (vacío = sin control)</span>
              <input
                className="input"
                type="number"
                min="0"
                placeholder="Vacío = siempre disponible"
                value={editing.stock}
                onChange={(e) =>
                ...
                <div className="am-item" key={p.id}>
                  ...
                  <div className="am-info">
                    <b>
                      ...
                      {p.stock === 0 && <em className="am-stock-out"> (agotado)</em>}
                    </b>
                    <span>
